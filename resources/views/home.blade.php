                        ...
                        <div class="jumbotron pt-3 pb-2 mb-4" style="min-height: 320px;
                            ...
                            <div class="row">
                                ...
                                <div class="col mx-3 rounded" style="background-color:rgba(0, 0, 0, 0.8);">
                                    <h4 class="text-light pt-3 mb-2">Your Rebate Codes for 'Chekov\'s Dreamers':</h4>
                                    ...
                                    <a href="https://place2book.com/en/sw2/sales/event_list/EM175/ncq069vcfc"
                                        target="_blank"
                                        class="btn btn-lg btn-outline-info btn-block border-white text-white mb-3">Go To
                                        Ticket Sales Page</a>
                                    {{-- <a href="ticketsales/161"
