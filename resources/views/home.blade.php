...
<div class="container py-3">
  <div class="row scrollbox">
    ...
    <div class="jumbotron pt-3 pb-2 mb-4" style="min-height: 320px;
                    ...
                    background: no-repeat url('media/putting.png');
      ...
      <div class="row">
        ...
        <div class="col mx-3 rounded" style="background-color:rgba(0, 0, 0, 0.8);">
          <h4 class="text-light pt-3 mb-2">Your Rebate Codes for 'Putting It Together':</h4>
          ...
          <a href="https://place2book.com/en/sw2/sales/event_list/EM175/ncq069vcfc" target="_blank" class="btn btn-lg btn-outline-info btn-block border-white text-white mb-3">Go To Ticket Sales Page</a>
          <a href="ticketsales/161" class="btn btn-lg btn-outline-info btn-block border-white text-white mb-4">Check Ticket Sales Stats</a>
        </div>
      </div>
    </div>
