                      ...
                      <table class="table table-striped" >
                        ...
                        @foreach ($people as $person)
                          ...
                          <tr>
                            ...
                            @if ($person->portraits->count()>0)
                              @foreach ($person->portraits as $portrait)
                                @if ($loop->last)
                                  <img src="https://ctc-members-balmec.imgix.net/{{$portrait->file_name}}?fit=crop&w=123&h=123&crop=faces&facepad=1.7&fit=facearea" alt="" style="object-fit: cover; height: 50px; width: 50px; border-radius: 50%; border: solid grey 1px; ">
                                @endif
                              @endforeach
                            @else
